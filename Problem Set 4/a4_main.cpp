...
void testComputeFactor() {
  ...
  w1.write("ante2-w1.png");
  w2.write("ante2-w2.png");
...
void testMakeHDR() {
  ...
  hdrScale0.write("scaledHDR_design_0.png");
  Image hdrScale2 = gamma_code((2e2) * hdr / maxVal, 2.2);
  hdrScale2.write("scaledHDR_design_2.png");
  Image hdrScale4 = gamma_code((2e4) * hdr / maxVal, 2.2);
  hdrScale4.write("scaledHDR_design_4.png");
  Image hdrScale6 = gamma_code((2e6) * hdr / maxVal, 2.2);
  hdrScale6.write("scaledHDR_design_6.png");
  Image hdrScale8 = gamma_code((2e8) * hdr / maxVal, 2.2);
  hdrScale8.write("scaledHDR_design_8.png");
  Image hdrScale10 = gamma_code((2e10) * hdr / maxVal, 2.2);
  hdrScale10.write("scaledHDR_design_10.png");
}
...
void testToneMapping_ante2() {
  ...
  tm.write("ante2-tonedHDRsimple-gauss.png");
  cout << endl << "gaus";

  // tone map with bilateral
  tm = toneMap(hdr, 100, 3, true, 0.1);
  tm = gamma_code(tm, 2.2);
  tm.write("ante2-tonedHDRsimple-bilateral.png");
  cout << endl << "bilateral";
}
...
void testToneMapping_boston() {
  ...
  Image tm = toneMap(hdr, 100, 1, false);
  tm = gamma_code(tm, 2.2);
  tm.write("boston-tonedHDRsimple-gauss.png");

  // tone map with bilateral
  tm = toneMap(hdr, 100, 3, true, 0.1);
  tm = gamma_code(tm, 2.2);
  tm.write("boston-tonedHDRsimple-bilateral.png");
}
...
int main() {
  ...
  // testComputeFactor();
   //testMakeHDR();
  //Image buh("AMSTERDAM.png");

  // cout << endl << image_minnonzero(buh);
